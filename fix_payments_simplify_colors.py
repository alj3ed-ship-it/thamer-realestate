# -*- coding: utf-8 -*-
"""
Patch: تبسيط تلوين عمود "المبلغ" بتقرير الدفعات المصدَّر — المبلغ الأساسي
نص عادي دايماً، والأحمر يقتصر بس على "متبقي" بالسطر الفرعي (نفس مبدأ
تبسيط تقرير الاستحقاقات).

الاستخدام:
    cd C:\\Users\\aljuaid\\Desktop\\thamer-realestate
    python fix_payments_simplify_colors.py
"""
import pathlib
