...
// ===== تحويل ميلادي -> هجري باستخدام تقويم "أم القرى" الرسمي (عبر Intl) =====
        ...
        <>
          <div style={{ display: "flex", gap: 16, marginBottom: 28, flexWrap: "wrap" }}>
            <div style={{ flex: "1 1 220px", background: "#fff", border: "1px solid #1B4D7A33", borderTop: "4px solid #1B4D7A", borderRadius: 14, padding: "18px 22px", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", textAlign: "center" }}>
              <div style={{ fontSize: 13, color: "#6b7280", marginBottom: 6, fontWeight: 600 }}>إجمالي العقود{filterPropertiesMulti.length > 0 ? " (مصفّى)" : ""}</div>
          ...
          {displayedPropertiesForCards.length === 0 && (
