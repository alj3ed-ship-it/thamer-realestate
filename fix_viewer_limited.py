...
old_sort = """  const filteredPaymentsList = allowedPayments
    .filter((p) => {
...
assert content.count(old_sort) == 1, "sort block not found in ViewerLimited"
...
assert content.count(old_amount) == 1, "amount block not found in ViewerLimited"
