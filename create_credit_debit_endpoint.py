...
content = '''// Vercel serverless function. Issues a Credit or Debit Note referencing an
...
path = pathlib.Path("api/zatca-credit-debit-note.js")
assert not path.exists(), "الملف موجود مسبقاً — لا نكتب فوقه بدون مراجعة"
